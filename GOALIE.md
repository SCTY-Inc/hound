...
| B8 | pending | systemd user socket/service unit for `houndd` (activation allowed; systemd is not a scheduler). | Unit under `ops/systemd/`; socket-activated query round-trip. |
